...
const handler = tfn.io.fileSystem("/Users/zakariaattaoui/Downloads/ssdlite_mobilenet_v2_1_default_1/model.json");
const midgardFile = tfn.io.fileSystem("")
...
const loadModel = async function () {
  ...
  model = await tf.loadGraphModel(handler, {fromTFHub: true});
